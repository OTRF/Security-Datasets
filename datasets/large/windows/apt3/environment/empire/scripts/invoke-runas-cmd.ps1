...
Reference: https://dotnetcodetips.com/Tip/69/Powershell-script-to-run-an-exe-pass-arguments-and-redirect-output
Reference: https://github.com/EmpireProject/Empire/blob/master/data/module_source/management/Invoke-RunAs.ps1
#>
    [CmdletBinding()]Param (
    [Parameter(
