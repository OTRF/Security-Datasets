...
| Technique(s)          | ['[T1003](https://attack.mitre.org/techniques/T1003)'] |
| Simulaton Environment | Mordor shire |
| Simulation Scripts    | ['https://github.com/OTRF/Blacksmith/blob/master/aws/mordor/cfn-files/scripts/Invoke-Mimikatz.ps1'] |
| Dataset Host           | ['https://raw.githubusercontent.com/OTRF/mordor/master/datasets/small/windows/credential_access/host/empire_mimikatz_export_master_key.tar.gz'] |
| References        | None |
...
mordor_file = "https://raw.githubusercontent.com/OTRF/mordor/master/datasets/small/windows/credential_access/host/empire_mimikatz_export_master_key.tar.gz"
