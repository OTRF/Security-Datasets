...
| platform              | Windows |
| Tactic(s)             | ['[TA0005](https://attack.mitre.org/tactics/TA0005)', '[TA0008](https://attack.mitre.org/tactics/TA0008)'] |
| Technique(s)          | ['[T1550.002](https://attack.mitre.org/techniques/T1550/002)'] |
| Simulaton Environment | Mordor shire |
| Simulation Scripts    | ['https://github.com/OTRF/Blacksmith/blob/master/aws/mordor/cfn-files/scripts/Invoke-Mimikatz.ps1'] |
| Dataset Host           | ['https://raw.githubusercontent.com/OTRF/mordor/master/datasets/small/windows/credential_access/host/empire_mimikatz_opth.tar.gz'] |
| References        | None |
...
mordor_file = "https://raw.githubusercontent.com/OTRF/mordor/master/datasets/small/windows/credential_access/host/empire_mimikatz_opth.tar.gz"
