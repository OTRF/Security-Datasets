...
|                       |    |
|:----------------------|:---|
| id                    | SDWIN-190518184109 |
| author                | Roberto Rodriguez @Cyb3rWard0g |
| creation date         | 2019/05/18 |
| platform              | Windows |
| Tactic(s)             | ['[TA0003](https://attack.mitre.org/tactics/TA0003)'] |
| Technique(s)          | ['[T1053.005](https://attack.mitre.org/techniques/T1053/005)'] |
| Simulaton Environment | Mordor shire |
| Simulation Scripts    | ['https://github.com/EmpireProject/Empire/blob/dev/data/module_source/persistence/Persistence.psm1'] |
| Dataset Host           | ['https://raw.githubusercontent.com/OTRF/mordor/master/datasets/small/windows/persistence/host/empire_elevated_schtasks.tar.gz'] |
| References        | None |
...
mordor_file = "https://raw.githubusercontent.com/OTRF/mordor/master/datasets/small/windows/persistence/host/empire_elevated_schtasks.tar.gz"
